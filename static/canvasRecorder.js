...
function CanvasRecorder(canvas, video_bits_per_sec) {
    ...
    function startRecording() {
        ...
        let options = { 
            mimeType: supportedType || 'video/webm,codecs=vp9',
            videoBitsPerSecond: video_bits_per_sec || 2500000 // 5Mbps
        };
    ...
    function doneEncoding(videoBlob) {
    fetch('/saveVideo', {
        method: "POST", 
        body:videoBlob
    }).then(function(response) {
            console.log(document.cookie);
            window.location.href = '/video2images';
