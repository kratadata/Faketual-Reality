...
from lib.ops import *
from lib.dataloader import inference_data_loader, frvsr_data_loader
...
Flags.DEFINE_string('output_dir', '/cluster/work/infk_mtc/alessiapacca/TecoGAN/checkpoint', 'The output directory of the checkpoint')
...
Flags.DEFINE_string('input_video_dir', '/cluster/work/infk_mtc/alessiapacca/TecoGAN/HR', 'The directory of the video input data, for training')
Flags.DEFINE_string('input_video_pre', '', 'The pre of the directory of the video input data')
Flags.DEFINE_integer('str_dir', 0, 'The starting index of the video directory')
Flags.DEFINE_integer('end_dir', 0, 'The ending index of the video directory')
Flags.DEFINE_integer('end_dir_val', 1, 'The ending index for validation of the video directory')
Flags.DEFINE_integer('max_frm', 1288, 'The ending index of the video directory')
# The loss parameters
...
FLAGS = Flags.FLAGS
FLAGS.input_dir_LR = '/cluster/work/infk_mtc/alessiapacca/TecoGAN/LR/0'
FLAGS.input_dir_HR = '/cluster/work/infk_mtc/alessiapacca/TecoGAN/HR/0'
FLAGS.input_video_dir = '/cluster/work/infk_mtc/alessiapacca/TecoGAN/HR'
